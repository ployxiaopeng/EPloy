...
{
    unsafe class EPloy_ILRuntimeModule_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EPloy.ILRuntimeModule);
            args = new Type[]{};
        ...
        static StackObject* get_GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EPloy.ILRuntimeModule instance_of_this_method = (EPloy.ILRuntimeModule)typeof(EPloy.ILRuntimeModule).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
