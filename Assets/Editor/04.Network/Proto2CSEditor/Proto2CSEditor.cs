...
namespace ETNetwork.Editor
{
    ...
    public class Proto2CSEditor : EditorWindow
    {
        ...
        private const string clientMessagePath = "Assets/Scripts/Model/Module/Message/";
        private const string hotfixMessagePath = "Assets/Scripts/Hotfix/Component/Network/Message/";
        private static readonly char[] splitChars = { ' ', '\t' };
        private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();

        [MenuItem("Tools/ETNetwork/Proto2CS")]
        public static void AllProto2CS()
        {
            ...
            string outerMessageCodePath = Utility.Path.GetCombinePath(rootDir, "Assets", "Scripts", "Model", "Module", "Message/");

            string hotfixMessageCodePath = Utility.Path.GetCombinePath(rootDir, "Assets", "Scripts", "Hotfix", "Component", "Network", "Message/");
