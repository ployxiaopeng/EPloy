...
{
    unsafe class GameFramework_Scene_LoadSceneDependencyAssetEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.Scene.LoadSceneDependencyAssetEventArgs);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameFramework.Scene.LoadSceneDependencyAssetEventArgs instance_of_this_method = (GameFramework.Scene.LoadSceneDependencyAssetEventArgs)typeof(GameFramework.Scene.LoadSceneDependencyAssetEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
