...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Security_Cryptography_HashAlgorithm_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("ComputeHash", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ComputeHash_2);
        ...
        static StackObject* ComputeHash_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.ComputeHash(@buffer, @offset, @count);
        ...
        static StackObject* ComputeHash_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
