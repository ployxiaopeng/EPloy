...
namespace ETModel
{
    ...
    /// 数据表组件。
    /// </summary>
    public sealed class DataTableComponent : Component
    {
        private const int DefaultPriority = 0;
        public IDataTableManager DataTableManager { get; set; }
        /// <summary>
        /// 获取数据表数量。
        /// </summary>
        public int Count
        ...
        public void LoadDataTable(Type dataRowType, string dataTableName, string dataTableNameInType, string dataTableAssetName, LoadType loadType, int priority, object userData)
        {
            ...
            DataTableManager.LoadDataTable(dataTableAssetName, loadType, priority, new LoadDataTableInfo(dataRowType, dataTableName, dataTableNameInType, userData));
        }
        ...
        {
            return DataTableManager.HasDataTable(dataRowType);
        }
        ...
        {
            return DataTableManager.HasDataTable(dataRowType, name);
        }
        ...
        {
            return DataTableManager.GetDataTable(dataRowType);
        }
        ...
        {
            return DataTableManager.GetDataTable(dataRowType, name);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(text);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, text);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(name, text);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, name, text);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(bytes);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, bytes);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(name, bytes);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, name, bytes);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(stream);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, stream);
        }
        ...
        {
            return DataTableManager.CreateDataTable<T>(name, stream);
        }
        ...
        {
            return DataTableManager.CreateDataTable(dataRowType, name, stream);
        }
        ...
        {
            return DataTableManager.DestroyDataTable(dataRowType);
        }
        ...
        {
            return DataTableManager.DestroyDataTable(dataRowType, name);
        }
    }
}
