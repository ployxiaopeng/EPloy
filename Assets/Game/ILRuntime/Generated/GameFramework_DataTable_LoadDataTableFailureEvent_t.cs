...
{
    unsafe class GameFramework_DataTable_LoadDataTableFailureEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.DataTable.LoadDataTableFailureEventArgs);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameFramework.DataTable.LoadDataTableFailureEventArgs instance_of_this_method = (GameFramework.DataTable.LoadDataTableFailureEventArgs)typeof(GameFramework.DataTable.LoadDataTableFailureEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
