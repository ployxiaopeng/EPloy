...
namespace EPloy.Game
{
    ...
    public abstract class EPloySerializer<T>
    {
        ...
        public bool Serialize(Stream stream, T data, byte version)
        {
            ...
            {
                Log.Fatal(UtilText.Format("Serialize callback '{0}' is not exist.", version.ToString()));
                return false;
            }
        ...
        public T Deserialize(Stream stream)
        {
            ...
            {
                Log.Fatal(UtilText.Format("Header is invalid, need '{0}{1}{2}', current '{3}{4}{5}'.",
            ...
            {
                Log.Fatal(UtilText.Format("Deserialize callback '{0}' is not exist.", version.ToString()));
                return default(T);
            }
