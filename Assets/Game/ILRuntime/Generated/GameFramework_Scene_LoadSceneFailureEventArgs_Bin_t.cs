...
{
    unsafe class GameFramework_Scene_LoadSceneFailureEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.Scene.LoadSceneFailureEventArgs);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameFramework.Scene.LoadSceneFailureEventArgs instance_of_this_method = (GameFramework.Scene.LoadSceneFailureEventArgs)typeof(GameFramework.Scene.LoadSceneFailureEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
