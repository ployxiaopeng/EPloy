...
namespace EPloy
{
    ...
    public struct TypeLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public TypeLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
            if (first == null || terminal == null || first == terminal)
            {
                throw new EPloyException("Range is invalid.");
            }
        ...
        {
            private readonly TypeLinkedListRange<T> m_GameFrameworkLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(TypeLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new EPloyException("Range is invalid.");
