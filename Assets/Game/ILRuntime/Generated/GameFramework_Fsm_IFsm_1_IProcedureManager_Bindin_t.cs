...
namespace ILRuntime.Runtime.Generated
{
    unsafe class GameFramework_Fsm_IFsm_1_IProcedureManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ETModel.VarString)};
            if (genericMethods.TryGetValue("GetData", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.VarString), typeof(System.String)))
                    {
            ...
            if (genericMethods.TryGetValue("SetData", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(ETModel.VarString)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* GetData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetData<ETModel.VarString>(@name);
        ...
        static StackObject* SetData_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ETModel.VarString @data = (ETModel.VarString)typeof(ETModel.VarString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.SetData<ETModel.VarString>(@name, @data);
