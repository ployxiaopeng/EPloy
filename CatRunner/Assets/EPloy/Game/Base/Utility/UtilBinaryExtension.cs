...
/// </summary>
public static class UtilBinaryExtension
{
    ...
    public static string ReadEncryptedString(this BinaryReader binaryReader, byte[] encryptBytes)
    {
        ...
        UtilEncryption.GetSelfXorBytes(s_CachedBytes, 0, length, encryptBytes);
        string value = UtilConverter.GetString(s_CachedBytes, 0, length);
