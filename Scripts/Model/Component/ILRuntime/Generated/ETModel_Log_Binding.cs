...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Log_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.String), typeof(System.Object[])};
            method = type.GetMethod("Info", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Info_7);
            args = new Type[]{typeof(System.String), typeof(System.Object)};
            method = type.GetMethod("Warning", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Warning_8);
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("Error", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Error_9);
        ...
        static StackObject* Error_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Log.Error(@format, @arg0, @arg1, @arg2);
        ...
        static StackObject* Error_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Log.Error(@format, @arg0, @arg1);
        ...
        static StackObject* Error_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Log.Error(@format, @arg0);

            return __ret;
        }

        static StackObject* Info_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ETModel.Log.Info(@format, @args);

            return __ret;
        }

        static StackObject* Warning_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ETModel.Log.Warning(@format, @arg0);

            return __ret;
        }

        static StackObject* Error_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
