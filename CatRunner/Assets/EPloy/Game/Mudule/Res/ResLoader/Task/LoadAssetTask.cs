...
namespace EPloy.Game.Res
{
    internal sealed class LoadAssetTask : LoadResTaskBase
    {
        ...
        public static LoadAssetTask Create(string assetName, Type assetType, ResInfo resInfo, string[] depenAssetNames, LoadAssetCallbacks loadAssetCallbacks,object userData)
        {
            LoadAssetTask loadAssetTask = ReferencePool.Acquire<LoadAssetTask>();
            loadAssetTask.Initialize(assetName, assetType, resInfo, depenAssetNames,userData);
