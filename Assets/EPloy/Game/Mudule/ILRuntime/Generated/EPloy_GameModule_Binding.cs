...
{
    unsafe class EPloy_GameModule_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EPloy.GameModule);
            args = new Type[]{};
            method = type.GetMethod("get_ResUpdater", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_ResUpdater_0);
            args = new Type[]{};
            method = type.GetMethod("get_Timer", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Timer_1);
            args = new Type[]{};
        ...
        static StackObject* get_ResUpdater_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_Timer_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
