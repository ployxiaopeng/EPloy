...
public class StartForm : UIForm
{
    ...
    public override void Create()
    {
        ...
        HotFixMudule.Net.AddListener(HotfixOpcode.G2C_Register, G2C_Register);
        ...
        UIEventListener.Get(bindingCode.btnObjTest).onClick = (go) =>
        {
            ...
            {
                HotFixMudule.Obj.ShowObj(UIEffectData.Create(1001, transform), (effec) =>
                {
            ...
            {
                HotFixMudule.Obj.HideObj(uIEffectData.SerialId);
                uIEffectData = null;
            }
