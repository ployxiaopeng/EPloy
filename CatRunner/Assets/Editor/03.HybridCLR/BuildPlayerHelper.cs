...
namespace EPloy.Editor
{
    public class BuildPlayerHelper
    {
        ...
        public static void Build_Win64()
        {
            ...
            string location = $"{outputPath}/EPloy.exe";

            Debug.Log("====> Build App");
            BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions()
            {
                scenes = new string[] { "Assets/Scenes/Start.unity" },
        ...
        [MenuItem("EPloy/Build/Android64")]
        public static void Build_Android64()
        {
            ...
            string location = outputPath + "/EPloy.apk";
            BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions()
            {
                scenes = new string[] { "Assets/Scenes/Start.unity" },
                locationPathName = location,
