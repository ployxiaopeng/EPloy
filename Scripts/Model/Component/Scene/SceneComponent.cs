...
namespace ETModel
{
    ...
    /// 场景组件。
    /// </summary>
    public sealed class SceneComponent : Component
    {
        private const int DefaultPriority = 0;
        public ISceneManager SceneManager { get; set; }
        public Camera MainCamera { get; set; }
        public Scene  GameFrameworkScene { get; set; } 
        ...
        {
            return SceneManager.SceneIsLoaded(sceneAssetName);
        }
        ...
        {
            return SceneManager.GetLoadedSceneAssetNames();
        }
        ...
        {
            SceneManager.GetLoadedSceneAssetNames(results);
        }
        ...
        {
            return SceneManager.SceneIsLoading(sceneAssetName);
        }
        ...
        {
            return SceneManager.GetLoadingSceneAssetNames();
        }
        ...
        {
            SceneManager.GetLoadingSceneAssetNames(results);
        }
        ...
        {
            return SceneManager.SceneIsUnloading(sceneAssetName);
        }
        ...
        {
            return SceneManager.GetUnloadingSceneAssetNames();
        }
        ...
        {
            SceneManager.GetUnloadingSceneAssetNames(results);
        }
        ...
        public void UnloadScene(string sceneAssetName, object userData)
        {
            ...
            SceneManager.UnloadScene(sceneAssetName, userData);
        }
