...
namespace ETTools
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            ProcessHelper.Run(protoc, "--csharp_out=\"../Unity/Assets/ET.Core/Module/Message/Message\" --proto_path=\"./\" OuterMessage.proto", waitExit: true);
            ProcessHelper.Run(protoc, "--csharp_out=\"../Unity/Assets/ET.Core/Module/Message/Message\" --proto_path=\"./\" HotfixMessage.proto", waitExit: true);
        ...
        private const string clientMessagePath = "../Unity/Assets/ET.Core/Module/Message/Message";
        private const string hotfixMessagePath = "../Unity/Assets/Model/Module/Message/Message";
    ...
    {
        private const string protoPath = ".";
        private const string serverMessagePath = "../Unity/Assets/ET.Core/Module/Message/Message";
        private static readonly char[] splitChars = { ' ', '\t' };
        private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();
