...
{
    unsafe class ETModel_UIGroupHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.UIGroupHelper);
            args = new Type[]{};
        ...
        static StackObject* get_Group_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.UIGroupHelper instance_of_this_method = (ETModel.UIGroupHelper)typeof(ETModel.UIGroupHelper).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
