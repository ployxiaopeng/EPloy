...
{
    unsafe class ETModel_ResourceComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ResourceComponent);
            args = new Type[]{typeof(System.String), typeof(System.Type), typeof(GameFramework.Resource.LoadAssetCallbacks), typeof(System.Object)};
        ...
        static StackObject* LoadAsset_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ResourceComponent instance_of_this_method = (ETModel.ResourceComponent)typeof(ETModel.ResourceComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
