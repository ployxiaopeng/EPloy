...
namespace ETModel
{
    ...
    public class EventComponent : Component
    {
        ...
        public int EventHandlerCount
        {
            get
            {
                return EventManager.EventHandlerCount;
            }
        }
        ...
        public int EventCount
        {
            get
            {
                return EventManager.EventCount;
            }
        }
        ...
        {
            return EventManager.Check(id, handler);
        }
        ...
        {
            EventManager.SetDefaultHandler(handler);
        }
