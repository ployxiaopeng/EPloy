...
{
    unsafe class EPloy_Res_ResName_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EPloy.Res.ResName);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_Variant", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Variant_2);
            args = new Type[]{};
            method = type.GetMethod("get_Extension", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Extension_3);

            app.RegisterCLRCreateDefaultInstance(type, () => new EPloy.Res.ResName());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref EPloy.Res.ResName instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as EPloy.Res.ResName[];
        ...
        static StackObject* get_Variant_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_Extension_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
