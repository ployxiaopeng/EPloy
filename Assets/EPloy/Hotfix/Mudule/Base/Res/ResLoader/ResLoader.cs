...
namespace EPloy.Res
{
    ...
    public sealed class ResLoader
    {
        ...
        {
            AssetPool = HotFixMudule.ObjectPool.CreateObjectPool(typeof(AssetObject), "AssetPool");
            ResourcePool = HotFixMudule.ObjectPool.CreateObjectPool(typeof(AssetObject), "ResPool");
        }
