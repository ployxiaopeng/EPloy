...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_IBeginDragHandler_Binding
    {
        ...
        static StackObject* OnBeginDrag_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.IBeginDragHandler instance_of_this_method = (UnityEngine.EventSystems.IBeginDragHandler)typeof(UnityEngine.EventSystems.IBeginDragHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
