...
namespace EPloy.Net {
  ...
  public partial class G2C_EnterMap : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::EPloy.Net.UnitInfo> _repeated_units_codec
        = pb::FieldCodec.ForMessage(18, global::EPloy.Net.UnitInfo.Parser);
    private pbc::RepeatedField<global::EPloy.Net.UnitInfo> units_ = new pbc::RepeatedField<global::EPloy.Net.UnitInfo>();
    /// <summary>
    /// 所有的unit
    /// </summary>
    public pbc::RepeatedField<global::EPloy.Net.UnitInfo> Units {
      get { return units_; }
      set { units_ = value; }
    }
