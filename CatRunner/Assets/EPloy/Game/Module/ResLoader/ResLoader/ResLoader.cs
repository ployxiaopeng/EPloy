...
namespace EPloy.Res
{
    ...
    public sealed class ResLoader : IResLoader
    {
        ...
        internal ResHelper ResHelper
        {
            get
            {
                return GameEntry.Res.ResHelper;
            }
        }
        /// <summary>
        /// 资产路径
        ...
        {
            AssetPool = GameEntry.ObjectPool.CreateObjectPool(typeof(ObjectAsset), "AssetPool");
            ResourcePool = GameEntry.ObjectPool.CreateObjectPool(typeof(ObjectAsset), "ResPool");
        }
        ...
        {
            ResInfo resInfo = GameEntry.ResUpdater.GetResInfo(assetName);
        ...
        {
            ResInfo resInfo = GameEntry.ResUpdater.GetResInfo(binaryAssetName);
        ...
        private bool CheckAsset(string assetName, out ResInfo resInfo, out string[] dependencyAssetNames)
        {
            ...
            AssetInfo assetInfo = GameEntry.ResUpdater.GetAssetInfo(assetName);
            if (assetInfo == null)
            {
                return false;
            }

            resInfo = GameEntry.ResUpdater.GetResInfo(assetInfo.ResName);
            if (resInfo == null)
            {
                return false;
            }
