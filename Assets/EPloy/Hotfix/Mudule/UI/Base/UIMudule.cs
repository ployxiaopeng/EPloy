...
namespace EPloy
{
    ...
    public class UIMudule : IHotfixModule
    {
        ...
        public override void Awake()
        {
            ...
            UIPool = HotFixMudule.ObjectPool.CreateObjectPool(typeof(UIFormObject), "UIPool");
        ...
        public void OpenUIForm(UIName uiName, UIGroupName groupName, object userData = null)
        {
            ...
            if (assetObject == null)
            {
                ...
                HotFixMudule.Res.LoadAsset(path, typeof(GameObject), LoadAssetCallbacks, UIFormInfo);
            }
            else
            {
