...
{
    unsafe class GameFramework_Utility_Binding_Assembly_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.Utility.Assembly);
        ...
        static StackObject* GetType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GameFramework.Utility.Assembly.GetType(@typeName);
