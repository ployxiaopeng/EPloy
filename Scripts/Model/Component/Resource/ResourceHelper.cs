...
namespace ETModel
{
    ...
    public class ResourceHelper : IResourceHelper
    {
        ...
        {
             Init.Instance.StartCoroutine(LoadBytesCo(fileUri, loadBytesCallback));
        }
        ...
        public  void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks, object userData)
        {
            ...
            try
            {
                Init.Instance.StartCoroutine(UnloadSceneCo(sceneAssetName, unloadSceneCallbacks, userData));
            }
            catch
            {
                Log.Error("SceneComponent 要添加");
                SceneManager.UnloadSceneAsync(Init.Scene.GetSceneName(sceneAssetName));
            }
#else
