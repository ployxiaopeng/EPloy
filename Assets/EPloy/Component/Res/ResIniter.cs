...
namespace EPloy.Res
{
    ...
    {
        private readonly Dictionary<ResName, string> m_CachedFileSystemNames;
        private string m_CurrentVariant;

        public EPloyAction ResourceInitComplete;

        /// <summary>
        /// 初始化资源初始化器的新实例。
        /// </summary>
        /// <param name="resourceManager">资源管理器。</param>
        public ResourceIniter()
        {
        ...
        public void InitResources(string currentVariant)
        {
            ...
            LoadBytes(Utility.Path.GetRemotePath(Path.Combine(m_ResourceManager.m_ReadOnlyPath, RemoteVersionListFileName)), new LoadBytesCallbacks(OnLoadPackageVersionListSuccess, OnLoadPackageVersionListFailure), null);
        }
