...
{
    unsafe class ETModel_EntityGroupHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.EntityGroupHelper);
            args = new Type[]{};
        ...
        static StackObject* get_Group_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.EntityGroupHelper instance_of_this_method = (ETModel.EntityGroupHelper)typeof(ETModel.EntityGroupHelper).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
