...
namespace ETModel
{
	...
	public class MessageDispatcherComponent : Component
	{
		...
		public void Load()
		{
			...
			List<Type> types = ModelGame.EventSystem.GetTypes(typeof(MessageHandlerAttribute));
		...
		public void Handle(INetworkChannel channel, MessageInfo messageInfo)
		{
			...
			foreach (IMHandler ev in actions)
			{
				try
				{
					ev.Handle(channel, messageInfo.Message);
				}
				catch (Exception e)
				{
					Log.Error(e);
