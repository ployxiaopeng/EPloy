...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEditor_AssetDatabase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("LoadMainAssetAtPath", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LoadMainAssetAtPath_1);
        ...
        static StackObject* LoadAssetAtPath_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEditor.AssetDatabase.LoadAssetAtPath(@assetPath, @type);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* LoadMainAssetAtPath_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = UnityEditor.AssetDatabase.LoadMainAssetAtPath(@assetPath);
