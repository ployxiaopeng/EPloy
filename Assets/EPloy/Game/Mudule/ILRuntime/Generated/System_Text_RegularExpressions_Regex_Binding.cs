...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Text_RegularExpressions_Regex_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, Unescape_0);


        }


        static StackObject* Unescape_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
