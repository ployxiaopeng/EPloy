...
namespace ETModel
{
    public static class ILRuntimeHelper
    {
        public static void InitILRuntime(AppDomain appDomain)
        {
            ...
            //Unity适配
            appDomain.DelegateManager.RegisterDelegateConvertor<ETModel.UIEventListener.UIListenerDelegate>((act) =>
            {
                return new ETModel.UIEventListener.UIListenerDelegate((go) =>
                {
            ...
            appDomain.RegisterCrossBindingAdaptor(new IProcedureBaseAdaptor());
            appDomain.RegisterCrossBindingAdaptor(new IGameEventArgsAdaptor());
            appDomain.RegisterCrossBindingAdaptor(new IDataRowBaseAdaptor());
            appDomain.RegisterCrossBindingAdaptor(new IReferenceAdaptor());
            appDomain.RegisterCrossBindingAdaptor(new IPacketAdaptor());
