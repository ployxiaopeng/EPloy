...
{
    unsafe class ETModel_DataRowBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.DataRowBase);
            args = new Type[]{};
        ...
        static StackObject* get_Id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.DataRowBase instance_of_this_method = (ETModel.DataRowBase)typeof(ETModel.DataRowBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
