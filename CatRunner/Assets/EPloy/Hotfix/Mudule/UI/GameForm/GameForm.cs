...
public class GameForm : UIForm
{
    ...
    public override void Create()
    {
        ...
        formData = HotFixMudule.DataStore.GetDataStore<GameFormData>();
    ...
    {
        Vector2 vector;
        RectTransformUtility.ScreenPointToLocalPointInRectangle(gameObject.transform as RectTransform, pointer.position, HotFixMudule.UI.UICamera, out vector);
